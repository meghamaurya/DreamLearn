...
const Classes = (props) => {
    const demoClass = props.demoClass;
        ...
        <div className="max-w-[1250px] mx-auto">
            ...
            {demoClass.length === 0 && loading ? (
                <div class="text-center">
                    <div role="status">
                        <svg class="inline mr-2 w-8 h-8 mt-10 text-gray-200 animate-spin dark:text-gray-600 fill-purple-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
