        ...
        <nav className="flex items-center py-1 bg-purple-900 text-white justify-between ">
          ...
          <div>
            <ul className=" flex  sm:mt-0 items-center py-2  space-x-10 px-20 text-xl ">
              <Link to="/" className="font-bold cursor-pointer mt-5 hover:rounded-lg hover:shadow-purple-100 shadow-lg">Home</Link>
              <Link to="/learn" className="font-bold cursor-pointer mt-5 hover:shadow-purple-100 hover:rounded-lg shadow-lg">Learn</Link>
            </ul>
          </div>
        </nav>
      </div>
