...
// import Instrument from '../InstrumentCourses';
...
//     //         }
//     //         LearnerService.instrumentDD(instrument).then((response) => {
//     //             console.log('click instrument', response.data.message)
//     //             var instrumentCourse = response.data.message;
//     //             <Instrument instrumentCourse={instrumentCourse} />
//     //             navigate('/instrumentCourses');
//     //         });
//     //     }
//     // }, [instruments])
...
//                             <div>
//                                 <Menu.Button className="inline-flex w-full justify-center bg-white px-4  font-medium text-purple-900 shadow-sm hover:bg-gray-50 ">
//                                     Instruments
...
//                                 return (
//                                     <div key={index} >
//                                         <div className="hover:font-semibold p-0.5"><Link to={`/instruments/${index}`}>{instrument}</Link></div>
//                                     </div>
//                                 )
//                             })}
//                         </div>
...
//             </div>
//         </div>
//         {instruments ? <Instrument instrumentCourse={instruments} /> : ''}
//     </>
//     )
// }
