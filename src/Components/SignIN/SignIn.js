                    ...
                    <div className="w-full">
                        ...
                        >
                            ...
                            {loading ? <div className="text-center pb-1">
                                <div role="status">
                                    <svg className="inline mr-1 w-5 h-5 text-gray-200 animate-spin dark:text-gray-600  fill-purple-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
