...
function SignIn() {
    ...
    const onSubmit = data => {
        ...
        if (loginbtn.current.context._errors.length === 0) {
        ...
        <div className=" max-w-[1250px] mx-auto overflow-hidden mt-11 grid grid-flow-row-dense md:grid-cols-2 lg:grid-cols-3 m-3 pl-10 pr-5 h-fit shadow-lg shadow-purple-500 ">
            ...
            <div className="w-full mt-4 max-w-80% flex justify-start items-center pt-2">
                <div className="w-full">
                    <form className="bg-white shadow-md rounded px-6 pt-6 pb-1 mb-3" ref={form} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='form-group'>
                            <button type='submit' ref={loginbtn} disabled={loading} className='btn bg-purple-900 text-white p-1 rounded-md shadow-md hover:bg-purple-500 hover:text-white hover:font-semibold shadow-purple-300 hover:shadow-purple-900 hover:shadow-md '>
                                {loading && (
                                    <div class="text-center">
                                        <div role="status">
                                            <svg class="inline mr-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-purple-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
