    ...
    <div>
      <section className="h-screen max-w-[1250px] mx-auto">
        <div className="px-6 h-full  text-gray-800">
          ...
          >
            <div
              className=" grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-8/12 md:w-8/12 mb-12 md:mb-0"
            >
              <Carousel className="w-full " />

            </div>
            <div className="2xl:w-6/12 xl:w-6/12 lg:w-4/12 md:w-8/12 mt-5 sm:w-11/12 ">
              <form>
